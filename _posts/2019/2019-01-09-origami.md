...
It basically consist on a selector wheel with 16 options, two on/off switches and a 3.5mm jack for flash sync. We don't need to stick a weight!
...
So I am thrilled of where we are so far, and I can assure you that there will be amazing news that I cannot reveal now.
