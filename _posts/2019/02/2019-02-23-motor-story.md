...
In that era, trains were either Fleischmann (and similar-compatible) or [Märklin](https://www.maerklin.de/en/) that had a dotted connection on the tracks. N-gauge and smaller scales didn't exist back then).
